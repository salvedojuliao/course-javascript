...
*/
const foodsInfo = `Até aqui, o array "brazilianFodds" possui ${brazilianFoods.length} itens: ${brazilianFoods[0]}, ${brazilianFoods[1]}, ${brazilianFoods[2]}`;
...
*/
// console.log(initial.toLowerCase());
...
// let dogNames = ['Chico', 'Zeca', 'Lilica', 'Matilda'];
