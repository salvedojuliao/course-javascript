...
// Outro jeito:
// const letterM = mozilla.indexOf('M');
// const letterD = mozilla.indexOf('D');
// const letterN = mozilla.indexOf('N');
// const mdn = mozilla[letterM] + mozilla[letterD] + mozilla[letterN];
// console.log(mdn)
